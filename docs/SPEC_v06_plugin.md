# Antfarm v0.6.2 — Claude Code Plugin Specification

**Status:** Draft (renumbered from v0.6 → v0.7 → v0.6.2)
**Date:** 2026-04-05
**Prerequisite:** v0.6.0 shipped (autonomous runs, mission model, autoscaler)
